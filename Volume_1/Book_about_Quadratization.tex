...
\documentclass[english,notitlepage,longbibliography,showpacs,preprintnumbers,amsmath,amssymb,aps,prx,nofootinbib,12pt,superscriptaddress]{revtex4-2}
...
\begin{align}
H_{{\rm 6-local}} &=-2b_{1}b_{2}b_{3}b_{4}b_{5}b_{6} + b_5b_6 \\
                  &=2((2(6) - 1)b_a - 2(\sum_{i = 1}^{6} b_{i}b_a)) + b_5b_6\nonumber 
\end{align}
has a unique minimum energy of -1 when all $b_i=1$.
