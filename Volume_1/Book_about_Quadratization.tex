...
{\footnotesize
\begin{align}
\left(x_1+3x_2\right)\left(z_1+z_2\right)y_3 \rightarrow & \alpha + \alpha^{xx}_{12}\left(x_1 + 3x_2\right)^2 + \alpha^{zz}_{12}\left(z_1 + z_2\right)^2 + \alpha^{yy}_{3}y_3^2 + \alpha^{xx}\left(x_1x_{a_{1}}  + 3x_2x_{a_{1}}\right)\\
& + \alpha^{zx}\left(z_1x_{a_{2}} + z_2x_{a_{2}}\right) + \alpha^{yx}y_3x_{a_{3}} + \alpha^{zz}\left(z_{a_{1}}z_{a_{2}} + z_{a_{1}}z_{a_{3}} + z_{a_{2}}z_{a_{3}}\right)
\end{align}
}
...
{\tiny
\begin{align}
z_1x_2 - x_1z_2y_3 - 3x_1x_2y_4 &\rightarrow z_1x_2 - 4\alpha - \alpha^{ss}_{1}\left(x_1^2 + z_2^2 + y_3^2\right) - 3\alpha^{ss}_{2}\left(x_1^2 + x_2^2 + y_4^2\right) - \alpha^{sx}_{1}\left(x_1x_{a_{11}} + z_2x_{a_12}+  y_3x_{a_{13}}\right) - 3\alpha^{sx}_{2}\left(x_1x_{a_{21}} + x_2x_{a_{22}} + y_4x_{a_{23}}\right)\\
& - \alpha^{zz}_{1}\left(z_{a_{11}}z_{a_{12}} + z_{a_{11}}z_{a_{13}} + z_{a_{12}}z_{a_{13}}\right) - 3\alpha^{zz}_{2}\left(z_{a_{21}}z_{a_{22}} + z_{a_{21}}z_{a_{23}} + z_{a_{22}}z_{a_{23}}\right)
\end{align}
}
