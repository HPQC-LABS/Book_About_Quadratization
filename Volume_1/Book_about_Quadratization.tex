...
\begin{align}
\begin{split}
-b_{1}b_{2}b_{3}b_{4}b_{5} + {5}b_{1}b_{4} - b_{3} &\rightarrow b_a + {2}\sum_{i=1}^{5}(1-b_i)(1-b_a) - 1 +5b_{1}b_{4} - b_{3} \\
&\rightarrow b_a + {9} - {10}b_a - {2}b_{1} - {2}b_2 - {2}b_3 - {2}b_4 - {2}b_5 + \\
&{2}b_{1}b_a + {2}b_{2}b_a + {2}b_{3}b_a + {2}b_{4}b_a + {2}b_{5}b_a + {5}b_{1}b_{4} - b_{3} \\
\end{split}
\end{align}
