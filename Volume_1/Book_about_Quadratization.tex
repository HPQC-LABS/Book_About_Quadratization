...
\item ALCN (at least $c$ out of $n$) and ECN (exact $c$ out of $n$) functions also cannot be quadratized with fewer than $\lceil \log(n)\reil - 1$ auxiliary variables (Corollaries 2 and 3 from \cite{Boros2018boundsPaper}).
