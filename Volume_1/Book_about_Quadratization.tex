...
\examplesec
\begin{align}
3x_{1}y_{2}z_{3}y_{4} \rightarrow & \frac{\Delta}{6}\sum_{i = 1}^{3}\sum_{j = 1}^{4}(1 - z_{a_{1j}}z_{a_{i}}) + \frac{\Delta}{6}\sum_{i = 1}^{3}\left(1 - z_{a_{i}} + \sum_{k = 1}^{3}(1 - z_{a_{i}}z_{a_{k}})\right) \\
& + \sqrt{\frac{3\Delta}{8}}\sum_{j = 1}^{4}((x_{1}y_{2} - z_{3}y_{4})x_{a_{1j}}) + 3
\end{align}
