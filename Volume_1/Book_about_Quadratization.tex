...
\alpha_{a}^{z} & \alpha_{1a}^{sx}\\
 \textrm{N/A} & \alpha_{2a}^{sx}
\end{pmatrix}&=\begin{pmatrix}\frac{\Delta}{2} & -\Delta^{1/3}a^{2/3}\\
\frac{a^{2/3}\Delta^{1/3}}{2} & \frac{a}{2}\\
\frac{a^{2/3}\Delta^{1/3}}{2} & \frac{a}{2}\\
-\frac{a^{1/3}\Delta^{2/3}}{2} & \frac{a^{1/3}\Delta^{2/3}}{2}\\
-\frac{\Delta}{2} & -\frac{a^{1/3}\Delta^{2/3}}{\sqrt{2}}\\
...
{\small
\begin{align}
3y_{1}z_{2}x_{3} \rightarrow & \frac{\Delta}{2} + \left(\frac{3^{\nicefrac{2}{3}}\Delta^{\nicefrac{1}{3}}}{2}\right)y_{1}^{2} + \left(\frac{3^{\nicefrac{2}{3}}\Delta^{\nicefrac{1}{3}}}{2}\right)z_{2}^{2} - \left(\frac{3^{\nicefrac{1}{3}}\Delta^{\nicefrac{2}{3}}}{2}\right)x_{3} - \left(\frac{\Delta}{2}\right)z_{a} - \left(3^{\nicefrac{2}{3}}\Delta^{\nicefrac{1}{3}}\right)y_{1}z_{2} \\
& + \left(\frac{3}{2}\right)y_{1}^{2}x_{3} + \left(\frac{3}{2}\right)z_{2}^{2}x_{3} + \left(	\frac{3^{\nicefrac{1}{3}}\Delta^{\nicefrac{2}{3}}}{2}\right)x_{3}z_{a} - \left(\frac{3^{\nicefrac{1}{3}}\Delta^{\nicefrac{2}{3}}}{\sqrt{2}}\right)y_{1}x_{a} + \left(\frac{3^{\nicefrac{1}{3}}\Delta^{\nicefrac{2}{3}}}{\sqrt{2}}\right)z_{2}x_{a}
\end{align}
}
...
{\small
\begin{align}
a \prod_i^3 s_{i} \rightarrow & \left(\Delta + \left(\frac{a}{2}\right)^{\nicefrac{1}{3}}\Delta^{\nicefrac{1}{2}}s_{3}\right)\left(\frac{1-z_{a}}{2}\right) + \left(\frac{a}{2}\right)^{\nicefrac{1}{3}}\Delta^{\nicefrac{3}{4}}({\rm sgn}(a)s_{1} + s_{2})x_{a} \\
& + \left(\frac{a}{2}\right)^{\nicefrac{2}{3}}\Delta^{\nicefrac{1}{2}}\left({\rm sgn}^2(a)+1\right)\left(\frac{1+z_{a}}{2}\right)
+ 2 {\rm sgn}(a)\left(\frac{a}{2}\right)^{\nicefrac{2}{3}}\Delta^{\nicefrac{1}{2}}s_{1}s_{2} \\
& - \frac{a}{2}({\rm sgn}^2(a)+1)s_{3}\left(\frac{1+z_{a}}{2}\right) \\
& - 2{\rm sgn}^2(a)\left(\frac{a}{2}\right)^{\nicefrac{4}{3}}\left(({\rm sgn}^2(a)+1)\left(\frac{1+z_{a}}{2}\right)+2{\rm sgn}(a)s_{1}s_{2}\right)
\end{align}
}
...
\examplesec
\begin{align}
3x_{1}z_{2}y_{3} \rightarrow & \left(\Delta + \left(\frac{3}{2}\right)^{\nicefrac{1}{3}}\Delta^{\nicefrac{1}{2}}y_{3}\right)\left(\frac{1-z_{a}}{2}\right) 
+ \left(\frac{3}{2}\right)^{\nicefrac{1}{3}}\Delta^{\nicefrac{3}{4}}(x_{1} + z_{2})x_{a} \\
& + \left(\frac{3}{2}\right)^{\nicefrac{2}{3}}\Delta^{\nicefrac{1}{2}}(1+z_{a})
+ 2 \left(\frac{3}{2}\right)^{\nicefrac{2}{3}}\Delta^{\nicefrac{1}{2}}x_{1}z_{2}
- 3y_{3}\left(\frac{1+z_{a}}{2}\right) \\
& - 2\left(\frac{3}{2}\right)^{\nicefrac{4}{3}}\left(1+z_{a}+2x_{1}z_{2}\right)
\end{align}
