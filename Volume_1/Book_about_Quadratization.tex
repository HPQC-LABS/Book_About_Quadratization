...
\begin{align}
a\prod_i^3 s_{i} \rightarrow \alpha   + \alpha^{ss} \sum_i s_i^2 + \alpha^{sx}\sum_i  s_ix_{a_i} + \alpha^{zz} \sum_{ij} z_{a_i}z_{a_j} + (6 - |a|)\openone
\end{align}
...
{\footnotesize
\begin{align}
z_1x_2 - 6x_1z_2y_3 - 6x_1x_2y_4 \rightarrow & z_1x_2 + 2\alpha\openone + \alpha^{ss}(2x_{1}^{2} + z_{2}^2 + y_{3}^{2} + x_{2}^{2} + y_{4}^{2}) \\
