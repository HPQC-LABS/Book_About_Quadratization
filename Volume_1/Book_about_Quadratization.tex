...
{\small
\begin{align}
\alpha \prod_i^3 s_{i} \rightarrow & \left(\Delta + \left(\frac{\alpha}{2}\right)^{\nicefrac{1}{3}}\Delta^{\nicefrac{1}{2}}s_{3}\right)\left(\frac{1-z_{a}}{2}\right) + \left(\frac{\alpha}{2}\right)^{\nicefrac{1}{3}}\Delta^{\nicefrac{3}{4}}({\rm sgn}(\alpha)s_{1} + s_{2})x_{a} \\
& + \left(\frac{\alpha}{2}\right)^{\nicefrac{2}{3}}\Delta^{\nicefrac{1}{2}}\left({\rm sgn}^2(\alpha)+1\right)\left(\frac{1+z_{a}}{2}\right)
+ 2 {\rm sgn}(\alpha)\left(\frac{\alpha}{2}\right)^{\nicefrac{2}{3}}\Delta^{\nicefrac{1}{2}}s_{1}s_{2} \\
& - \frac{\alpha}{2}({\rm sgn}^2(\alpha)+1)s_{3}\left(\frac{1+z_{a}}{2}\right) \\
& - 2{\rm sgn}^2(\alpha)\left(\frac{\alpha}{2}\right)^{\nicefrac{4}{3}}\left(({\rm sgn}^2(\alpha)+1)\left(\frac{1+z_{a}}{2}\right)+2{\rm sgn}(\alpha)s_{1}s_{2}\right)
\end{align}
}
