...
%\begin{array}{ccl}
%\displaystyle
\hspace{-3mm} \sum_{j}a_j H_{1j} H_{2j} \! \rightarrow \!  \alpha \sum_{ij}\! \left(1-z_{a_{ij}} z_{a_i} + \alpha_{j}x_{a_{ij}} \! \left(H_{1j}  - H_{2j}\right) \! \right) + \alpha \sum_i\!\left(1-z_{a_i} + \sum_{j}\left(1-z_{a_i} z_{a_j}\right)\!\right)\!.  \!\!\\
%\end{array}
\end{equation}
