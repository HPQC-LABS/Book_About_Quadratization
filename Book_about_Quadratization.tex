...
\subsection{PTR-BCR-6 (Boros, Crama, and Rodr\'{i}guez-Heck, 2018)} 
...
\begin{itemize}
\item Nick made contributions to the following sections: (1) RMS (in terms of z), (2) PTR-RBL-(3->2), (3) PTR-RBL-(4->2), (4) SBM, (5) Flag based SAT Mapping, and to the (6) qutrit -> qubit transformation.
\end{itemize}
...
% Daniel Nagaj (check to see how much the document he gave me was used and how it was used)
% Jake Biamonte (check contributions)
% Gruber gave us Ishikawa and maybe others since the book was written
% Charles gave us the SFRs and others
% Elisabeth gave us suggestions
