...
\refsec
\begin{itemize}
\item Original paper: \cite{yxkk19}. Derivation (Theorem 1), inspired by 2008, (Theorem 3): \cite{vchoi08}.
\item Background on CCG (Constraint composite graph): \cite{k08}.
\end{itemize}
