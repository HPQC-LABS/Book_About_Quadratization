...
Extra binary or ternary variable is added to ensure that the energy of the even parity sector is zero and the energy of the odd sector is higher. Requires introduction of a ternary variable $T \in \{ -1,0,1\}$.
...
%\end{eqnarray}
\begin{eqnarray}
-z_1z_2z_3z_4\rightarrow 16\,T+8\,T\sum_{i=1}^4 b_i+4\,\sum_{i=1}^4\sum_{j>i}^4b_i\,b_j+16
\end{eqnarray}
...
%\end{eqnarray}
\begin{eqnarray}
-z_1z_2z_3z_4\rightarrow (4T+\sum_{i=1}^4 z_i)^2
\end{eqnarray}
...
Extra binary or ternary variable is added to ensure that the energy of the odd  parity sector is zero and the energy of the even sector is higher.
...
%\end{eqnarray}
\begin{eqnarray}
z_1z_2z_3z_4\rightarrow (4\,b_a+2\,\sum_{i=1}^4 b_i-6)^2
\end{eqnarray}
...
%\end{eqnarray}
\begin{eqnarray}
z_1z_2z_3z_4\rightarrow (2\,z_a+\sum_{i=1}^4z_i)^2
\end{eqnarray}
