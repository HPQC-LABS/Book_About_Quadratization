...
\begin{array}{ccl}
\displaystyle
\sum_{j}a_j H_{1j} H_{2j} & \rightarrow & \alpha \sum_{ij} \left(1-z_{a_{ij}} z_{a_i} + \beta_j  \left(H_{1j}  - H_{2j}\right) x_{w_i^{(j)}} \right) + \alpha_2\sum_i(1-z_{a_i}) + \alpha_2\sum_{ii^\prime}\left(1-z_{a_i} z_{a_i^\prime}\right)  \\[0.1in]
\end{array}
\end{equation}
