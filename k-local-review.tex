...
When optimizing discrete functions, it is often easier when the function is qudaratic than if it is of higher degree. But notice that the cubic and quadratic funcitons:
...
\end{align}
 ...
 As an explicit example, consider reproducing the spectrum of $z_1z_2z_3=(2\,b_1-1)(2\,b_2-1)(2\,b_3-1)$. In this case we need to assign a higher energy to the $(1,1,1)$, $(0,0,1)$, $(0,1,0)$, and  $(1,0,0)$ states. A flag ($b_{f}$) which is forced into a higher energy state iff these conditions are satisfied can be constructed from two instances of $H_{3-\rm{SAT}}$ and an auxilliary qubit, combining these leads to
...
\subsection{$(3\rightarrow2)$-OT (Oliveira-Terhal, 2008)}
...
\begin{align}
H_{k-\rm{local}} \rightarrow \Delta \frac{1-z_a}{2} +  \frac{1}{2}H_1^2   + \frac{1}{2}H_2^2  +    \sqrt{\frac{\Delta}{2}}\left(  - H_1 + H_2   \right)x_a.
\end{align}
