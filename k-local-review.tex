...
Goal: Guarantee that $z_{a,k}=z_iz_j$ can be chained together to make large product terms consisting of $z$. 
...
The penalty term$P(z_{a_k},z_i,z_j)= \mp z_{a_k}z_iz_j$ guarantees that $z_{a_k}=\pm z_iz_j$. The three local term can be made from gadgets.
...
Let us use this method to reproduce the spectrum of the following five local Hamiltonian $z_1z_2z_3z_4z_5$.  The following three local gadget reproduces the spectrum of the three local term $\pm z_1z_2z_3$
