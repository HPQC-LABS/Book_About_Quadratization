...
\item High overhead in terms of number of auxiliary qubits and number of terms (see following section).
\end{itemize}
...
\begin{eqnarray}
\begin{gathered}
|1\rangle\langle1|_{3}\left(z_{a_{5}}-z_{a_{6}}+z_{a_{9}}-z_{a_{10}}\right)+|0\rangle\langle0|_{3}\left(z_{a_{11}}-z_{a_{12}}+z_{a_{15}}-z_{a_{16}}\right)+x_{4}\left(z_{a_{7}}-z_{a_{8}}\right)+z_{a_{13}}-z_{a_{14}} +\\
\frac{1}{\sqrt{2}}\left(x_{1}\lambda_{1,a_{5}}+y_{1}\lambda_{2,a_{5}}+x_{1}\lambda_{1,a_{6}}+y_{1}\lambda_{2,a_{6}}+x_{a_{1}}\lambda_{1,a_{7}}+y_{a_{1}}\lambda_{2,a_{7}}+x_{a_{1}}\lambda_{1,a_{8}}+y_{1}\lambda_{2,a_{8}}\right. +\\
x_{a_{2}}\lambda_{1,a_{7}}+y_{a_{2}}\lambda_{2,a_{7}}+x_{a_{2}}\lambda_{1,a_{8}}+y_{a_{2}}\lambda_{2,a_{8}}+x_{a_{2}}\lambda_{1,a_{9}}+y_{a_{2}}\lambda_{2,a_{9}}+x_{a_{2}}\lambda_{1,a_{10}}+y_{a_{2}}\lambda_{2,a_{10}}+x_{1}\lambda_{1,a_{11}}+\\
y_{1}\lambda_{2,a_{11}}+x_{a_{4}}\lambda_{1,a_{15}}+y_{a_{4}}\lambda_{2,a_{15}}+x_{a_{1}}\lambda_{4,a_{5}}+y_{a_{1}}\lambda_{5,a_{5}}+x_{a_{2}}\lambda_{4,a_{7}}+y_{a_{2}}\lambda_{5,a_{7}}+x_{2}\lambda_{4,a_{9}}+y_{2}\lambda_{5,a_{9}} +\\
x_{a_{3}}\lambda_{4,a_{11}}+y_{a_{3}}\lambda_{5,a_{11}}+x_{a_{4}}\lambda_{4,a_{13}}+y_{a_{4}}\lambda_{5,a_{13}}+x_{a_{2}}\lambda_{4,a_{15}}+y_{a_{2}}\lambda_{5,a_{15}}-\\
-x_{a_{1}}\lambda_{4,a_{6}}-y_{a_{1}}\lambda_{5,a_{6}}-x_{a_{2}}\lambda_{4,a_{8}}-y_{a_{2}}\lambda_{5,a_{8}}-x_{2}\lambda_{4,a_{10}}-y_{2}\lambda_{5,a_{10}}-x_{a_{3}}\lambda_{4,a_{12}}-y_{a_{3}}\lambda_{5,a_{12}}-\\
\left.-x_{a_{4}}\lambda_{4,a_{14}}-y_{a_{4}}\lambda_{5,a_{14}}-x_{2}\lambda_{4,a_{16}}-y_{2}\lambda_{5,a_{16}}\right)
\end{gathered}
\end{eqnarray}
...
\costsec
\begin{itemize}
\item 6 auxiliary qutrits and 4 auxiliary qubits (10 extra qudits in total).
\item 2 quartic, 4 cubic, and 2 quadratic terms becomes 27 quadratic terms and 5 linear terms in the Pauli-GellMann basis. 
\end{itemize}
