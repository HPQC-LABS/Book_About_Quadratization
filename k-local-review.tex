...
To create a system which maps $(z_1=-1)\vee (z_2=-1) \vee (z_3=-1)$ (up to an energy shift),  we use the following gadget:
%
\begin{align}
H_{3-\rm{SAT}}=(1-\sum_{i=1}^3 z_{a_i})(1-\frac{1}{2}\sum_{i=1}^3 z_{i})+\frac{1}{2}\sum_{i<j}^3 z_{a_i} z_{a_j}-1 \nonumber \\
=-\sum_{i=1}^3 z_{a_i}-\frac{1}{2}\sum_{i=1}^3 z_i+\frac{1}{2}\sum_{i<j}^3 z_{a_i} z_{a_j} +\frac{1}{2} \sum_{i=1}^3 z_i z_{a_i}.
\end{align}
