...
This method can be used to re-write positive  or negative cubic terms in terms of 6 quadratic terms.  The identity is given by:
\begin{align}
...
% chain-like structure means that long range connectivity not required.
\item Reproduces the full spectrum.
\end{itemize}
