...
\noindent where each $b_i$ can either be 0 or 1, both never go below a value of -1, and all minima have the form $(b_1,b_2,b_3,b_4) = (1,1,1,b_4)$.  Therefore if we are interested in the ground state of a discrete function of degree $k$, we may optimize either function and get exactly the same result. Part \ref{partDiagonal} gives more than 10 different ways to do this. 
