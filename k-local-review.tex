...
\refsec
\begin{itemize}
\item Original paper where $\alpha=1$: \cite{Oliveira2008}. For arbitrary $\alpha$: \cite{Bravyi2008}. Connection to improved version: \cite{Cao2015}.
\end{itemize}
