...
\refsec
\begin{itemize}
\item Originally presented for cubic terms by Kolmogorov and Zabih in 2004 \cite{Kolmogorov2004}. Generalized to arbitrary order by Freedman and Drineas in 2005: \cite{Freedman2005}.
...
This method can also be used to rewrite positive  or negative cubic terms in terms of 6 quadratic terms.
...
\begin{align}
\pm z_1z_2z_3 &= 3 \pm \left( z_1 +  z_2 + z_3 + z_a \right) + 2z_a \left(z_1 + z_2 +z_3) +  z_1z_2 + z_1z_3 + z_2z_3 \right).
\end{align}
...
\refsec
\begin{itemize}
\item Original paper: \cite{Chancellor2017}.
\end{itemize}
