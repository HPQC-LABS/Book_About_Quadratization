...
f(b) \rightarrow \alpha
+\alpha^{b}\sum_{i}b_{i}
+\sum_{i}^{m-1}\alpha^{b_{a1}}b_{a_{i}}
+\alpha^{b_{a2}}b_{a_{m}}
+\alpha^{bb}\sum_{ij}b_{i}b_{j}
+\sum_{i}\sum_{j}^{m-1}\alpha^{bb_{a1}}b_{i}b_{a_{j}}
+\alpha^{bb_{a2}}\sum_{i}b_{i}b_{a_{m}}
+\sum_{ij}^{m-1}\alpha^{b_{a}b_{a1}}b_{a_{i}}b_{a_{j}},
+\sum_{i}^{m-1}\alpha^{b_{a}b_{a2}}b_{a_{i}}b_{a_{m}},
\end{align}
}
...
\alpha^{b_{a,1}} & \alpha^{bb_{a,2}}\\
\alpha^{b_{a,2}} & \alpha^{b_{a}b_{a,1}}\\
 & \alpha^{b_{a}b_{a,2}}
\end{pmatrix}=\begin{pmatrix}(c+1)^{2} & 1\\
-2(c+1) & -2^{i+1}\\
(c+1)2^{i+1} & 2\left(1+2^{m-1}\right)\\
\left(1+2^{m-1}\right)\left(2^{m-1}-2c-1\right) & 2^{i+j}\\
 & - \left(1+2^{m-1}\right)2^{i}
\end{pmatrix}.
\end{align}
...
f(b) \rightarrow \alpha
+\alpha^{b}\sum_{i}b_{i}
+\sum_{i}^{m-1}\alpha^{b_{a,1}}b_{a_{i}}
+\alpha^{b_{a,2}}b_{a_{m}}
+\alpha^{bb}\sum_{ij}b_{i}b_{j}
+\sum_{i}\sum_{j}^{m-1}\alpha^{bb_{a,1}}b_{i}b_{a_{j}}
+\alpha^{bb_{a,2}}\sum_{i}b_{i}b_{a_{m}}
+\sum_{i,j}^{m-1}\alpha^{b_{a}b_{a,1}}b_{a_{i}}b_{a_{j}},
+\sum_{i}^{m-1}\alpha^{b_{a}b_{a,2}}b_{a_{i}}b_{a_{m}},
\end{align}
}
...
\end{pmatrix}=\begin{pmatrix}(c-1)^{2} & 1\\
-2(c-1) & +2^{i+1}\\
(1-c)2^{i+1} &-2\left(1+2^{m-1}\right)\\
\left(1+2^{m-1}\right)\left(2^{m-1}+2c-1\right) & 2^{i+j}\\
 & - \left(1+2^{m-1}\right)2^{i}
\end{pmatrix}.
\end{align}
...
-c & -2^{i}\\
(1+c)2^{i} & \left(1+2^{m}\right)\\
\left(1+2^{m}\right)\left(2^{m-1}-c-1\right) & 2^{i+j-1}\\
 & - \left(1+2^{m}\right)2^{i-1}
\end{pmatrix}.
\end{align}
