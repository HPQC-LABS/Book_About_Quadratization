...
Separate the $k$-local term that we wish to convert to 1-local, and separate all terms that are at momst $(k-1)$-local into ones that commmute with the $k$-local term  and ones that anti-commute with the $k$-local term:
