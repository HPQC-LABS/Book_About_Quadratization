...
\noindent Since the coefficient of $b_{1}b_{2}$ is 10, which is greater than the sum of all of the other coefficients involving $b_{1}$ or $b_{2}$, \uline{\textbf{\textit{it must be the case that $b_{1}b_{2}=0$}}}.
...
\subsection{NP-Nagaj (Nagaj, 2010)}
...
\noindent where $U_{{\rm 2-{\rm local}}}$ is an arbitrary 2-local unitary matrix that acts on qubits different from the ones labeled by "1" and "2". It was shown in \cite{Nagaj2010} that this Hamiltonian that is 4-local on qubits can be transformed into one that is quadratic in qubits and qutrits. Here we show the 2-local Hamiltonian for the case where $U_{{\rm 2-local}}={\rm CNOT}\equiv\frac{1}{2}\left(\openone+z_{3}+x_{4}-z_{3}x_{4}\right).$ The 4-local Hamiltonian is:
...
\noindent and after adding 4 auxiliary qubits labeled by $a_{1}$ to $a_{4}$ and 6 auxiliary qutrits labeled by $a_{5}$ to $a_{10}$ and acted on by the Gell-Mann matrices $\lambda_{1}$ to $\lambda_{9}$ given in the Appendix, we get the following 2-local Hamiltonian:

\begin{align}
H_{{\rm 2-local}}      &=\lambda_{6,a_{8}}+\frac{1}{2}\left(x_{1}\lambda_{1,a_{5}}+y_{1}\lambda_{2,a_{5}}+\lambda_{6,a_{5}}-z_{3}\lambda_{6,a_{5}}+x_{a_{1}}\lambda_{4,a_{5}}+y_{a_{1}}\lambda_{5,a_{5}}+x_{a_{1}}\lambda_{1,a_{6}} +\\
                       &y_{a_{1}}\lambda_{2,a_{6}}+2x_{4}\lambda_{6,a_{6}}+x_{a_{2}}\lambda_{4,a_{6}}+\right.\\
&	y_{a_{2}}\lambda_{5,a_{6}}+x_{a_{2}}\lambda_{1,a_{7}}+y_{a_{2}}\lambda_{2,a_{7}}+\lambda_{6,a_{7}}-z_{a_{1}}\lambda_{6,a_{7}}+x_{2}\lambda_{4,a_{7}}+y_{2}\lambda_{5,a_{7}}+x_{1}\lambda_{1,a_{8}}+y_{1}\lambda_{2,a_{8}}+z_{3}\lambda_{6,a_{8}}+x_{a_{5}}\lambda_{4,a_{9}}+ \\
&	\left.y_{a_{5}}\lambda_{5,a_{9}}+\lambda_{6,a_{9}}+x_{a_{6}}\lambda_{4,a_{9}}+y_{a_{6}}\lambda_{5,a_{9}}+x_{a_{6}}\lambda_{1,a_{10}}+y_{a_{6}}\lambda_{2,a_{10}}+\lambda_{6,a_{10}}+z_{3}\lambda_{6,a_{10}}+x_{2}\lambda_{4,a_{10}}+y_{2}\lambda_{5,a_{10}}\right),
\end{align}

\noindent which has the same low-lying spectrum as $H_{2-{\rm local}}$.
...
\cdot & \frac{\alpha^{1/3}\Delta^{2/3}}{\sqrt{2}}
\end{pmatrix}.
%\alpha      &= \frac{\Delta}{2} \\
...
\item Proof that $xx + zz$ or $xz$ is universal: \cite{Biamonte2008}.
...
% 2-> 2 gadgets: Oliveira-Terhal's paper describe the cross-gadget, fork-gadget, and triangle-gadget.
...
%Cao and Nagaj have some 2->2 gadgets.
