...
\end{align}
 ...
 As an explicit example, consider reproducing the spectrum of $z_1z_2z_3=(2\,b_1-1)(2\,b_2-1)(2\,b_3-1)$. In this case we need to assign a higher energy to the $(+1,+1,+1)$, $(-1,-1,+1)$, $(-1,+1,-1)$, and  $(+1,-1,-1)$ states. A flag ($b_{f}$) which is forced into a higher energy state iff these conditions are satisfied can be constructed from two instances of $H_{3-\rm{SAT}}$ and an auxilliary qubit, combining these leads to
