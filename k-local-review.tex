...
\begin{equation}
H_{4{\rm -local}}=b_{1}b_{2}(4+b_{3}+b_{3}b_{4})+b_{1}(b_{3}-3)+b_{2}(1-2b_{3}-b_{4})+F(x_{3},x_{4},x_{5},\ldots,x_{N})
\end{equation}
...
{\small
\begin{equation}
H_{2{\rm -local}}=6b_{1}b_{2}+b_{1}(b_{3}-3)+b_{2}(1-2b_{3}-b_{4})+F(x_{3},x_{4},x_{5},\ldots,x_{N})
\end{equation}
}
