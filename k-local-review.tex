...
\subsection{Even or Odd Sector Selection (Rochetto, Benjamin, Li)}

\summarysec

Extra binary or trinary variable is added to ensure that the energy of the odd or even parity sector is zero and the energy of the other sector is higher.
