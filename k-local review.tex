...
The left Kronecker product by a $2\times2$ identity matrix is implied by Eqs. \eqref{eq:XX+Z} and \eqref{eq:XZ+Z} in the following way for qubit operators $q\in\{z,x\}$, assuming $i<j$:
