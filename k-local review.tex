...
The penalty term$P(b_{a_k},b_i,z_j)= \mp b_{a_k}b_ib_j$ guarantees that $b_{a_k}=\pm b_ib_j$. The three local term can be mad from gadgets.
...
Auxilliary qubits can be made to "count" the number of of logical qubits in the $1$ configuration. By applying single qubit terms to the auxilliary qubits, the spectrum of \emph{any} permutation symmetric Hamiltonian can be reproduced. 
