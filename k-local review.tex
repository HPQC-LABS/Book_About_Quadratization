...
\affiliation{$^{3}$Oxford University, Physical and Theoretical Chemistry Laboratory, OX1 3BW, Oxford, UK,}
...
\subsubsection{Creating 3-body gadget from local X}\label{sec:5th_32}
