...
\begin{equation}
-b_{1}b_{2} \ldots b_{k} = \min_{b_a} \left\{ (k-1-\sum b_{i})b_a \right\}.
\end{equation}
...
RICHARD: this is asymmetric w.r.t. b1,b1,b3, so isn't there more options for how to transform the b1b2b3 in this case?
